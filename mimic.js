...
function drawEmoji(canvas, img, face) {
  ...
  ctx.font = '70px Arial';
  var fp = face.featurePoints[9];
  ctx.fillText(face.emojis.dominantEmoji, fp.x+7, fp.y);
...
function startInstructions() {
  ...
  ctx.fillText('Match Your Facial Expression to The EMOJION!!, 50, 100);
  ctx.fillText('10 Chances In All', 50, 200);
}
